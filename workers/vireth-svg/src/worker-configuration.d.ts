/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/vireth-svg/wrangler.jsonc workers/vireth-svg/src/worker-configuration.d.ts` (hash: f8fd4681c217ebaa1cddc9d55f5d2da3)
// Runtime types generated with workerd@1.20260701.1 2026-07-07 
interface __BaseEnv_Env {
	SERVICE_NAME: "vireth-svg";
	DEFAULT_IMAGE_URL: "https://raw.githubusercontent.com/musueman/VIRETH/6e78b7fc4d4d5bfb4aec3c06891c2a7650c38bf8/etc/arcadia5083-chatbot-start/ck5083-world-overview-life-zones-v1.png";
}
