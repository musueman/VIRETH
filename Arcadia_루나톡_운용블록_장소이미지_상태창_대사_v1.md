...
[인물·스토리]
세부 운영은 글로벌 로어 `인물운영과 스토리 진행`만 따른다. 시스템 본문과 다른 글로벌 로어에 같은 규칙을 중복하지 않는다.
...
## 글로벌 로어북: 인물 운영과 스토리 진행

별도 로어북 엔트리 `Arcadia_루나톡_로어북_인물운영과_스토리진행_v1.md`의 500자 이하 본문을 사용한다.
