...
const TALK_CHARACTER_DISPLAY_SCALE = 1.3;
const TALK_CHARACTER_TOP_INSET = 24;
...
const TALK_CHARACTER_SCALED_FRAME = scaleFrameFromCenter(
  TALK_CHARACTER_BASE_FRAME,
  TALK_CHARACTER_DISPLAY_SCALE
);
const TALK_CHARACTER_FRAME = {
  ...TALK_CHARACTER_SCALED_FRAME,
  y: TALK_CHARACTER_TOP_INSET
};
